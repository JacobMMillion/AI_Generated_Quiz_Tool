    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                chroma_creator = ChromaCollectionCreator(processor, embed_client) # From Task 5
                ...
                if submitted:
                    ...
                    generator = QuizGenerator(topic_input, questions, chroma_creator.db) # Initialize a QuizGenerator class, From Task 8
                    ...
                    st.write(f"Loading complete! Please click the 'Proceed' button")
        ...
        with st.container():
            ...
            quiz_manager = QuizManager(st.session_state['question_bank']) # From Task 9
            
            # Format the question and display it
            with st.form("MCQ"):
                
                # Set index_question using the Quiz Manager
